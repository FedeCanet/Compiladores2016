...
public class Subtraction extends Exp {
	...
	@Override public Object evaluate(State state) throws Exception{
		...
		return lanzarError("La evaluación de la Substraction no puede realizarse debido a que los operandos no son del tipo requerido, estos son " + value1 + " y " + value2);
	}
